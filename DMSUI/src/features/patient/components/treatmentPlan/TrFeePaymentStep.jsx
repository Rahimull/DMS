...
export default function TrFeePaymentStep({
  formData,
  updateSection,
  updateValue,
  errors,
  ...
  const handleChangePayment = (name, value) => {
    ...
    updateValue("treatmentPlan.totalFee", payable);
    updateValue("treatmentPlan.discount", discount);
    updateValue(
      "treatmentPlan.installment",
