...
const features = [
  ...
  },
  {
    title: "تکنالوژی مدرن",
    description:
      "ما از تکنالوژی و تجهیزات مدرن دندان و زیبای برای تشخیص دقیق‌تر و ارائه درمان بهتر استفاده می‌کنیم.",
          ...
          <div className="relative">
            ...
            <div className="rounded-[2rem] border border-blue-100 bg-white/90 p-6 shadow-[0_15px_50px_rgba(30,64,175,0.07)] backdrop-blur-sm sm:p-8 lg:p-10">
              ...
              <p className="mt-5 text-sm leading-8 text-slate-500 sm:text-base">
                ما داکتران باتجربه، تکنالوژی مدرن و رویکرد مبتنی بر نیازهای
